...
addPharmacy({coordinates:{lat:53.8013853,lng:-1.5643944},
    content:'<div class="map-click"><h4>Leeds</h4><h6>Woodhouse<br>Leeds<br>LS2 9JT</h6></div>'
});
addPharmacy({coordinates:{lat:53.9600,lng:-1.0873},
    content:'<div class="map-click"><h4>York</h4><h6>Heslington<br>York<br>YO10 5DD</h6></div>'
});
addPharmacy({coordinates:{lat:53.7960,lng:-1.7594},
    content:'<div class="map-click"><h4>Bradford</h4><h6>Richmond Rd<br>Bradford<br>BD7 1DP</h6></div>'
});
addPharmacy({coordinates:{lat:53.28359,lng:-2.14308},
    content:'<div class="map-click"><h4>Manchester</h4><h6>Oxford Rd<br>Manchester<br>M13 9PL</h6></div>'
});
